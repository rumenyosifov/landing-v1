...
export default function Home() {
  const mainHeadText = 'Cerrajeros en Esplugues';
  const mainText1 = '24/7 asistencia técnica de cerrajeros';
  const mainText2 = 'en Esplugues con mejor precio';
  ...
  return (
    <>
      <Head>
        <title>Cerrajeros en Esplugues, Barcelona, urgente barato y facil, 24 Horas 666 666 666</title>
        <meta name="description" content="Cerrajeros en Esplugues 24 horas ✓ Apertura de puertas, cambio de bombín y cerraduras ✓ Cerrajeros Urgentes ⛔ ECONÓMICOS☝ Llegamos en 15 min ..." />
      </Head>
