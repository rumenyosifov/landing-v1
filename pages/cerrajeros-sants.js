...
export default function Home() {
  const mainHeadText = 'Cerrajeros en Sants';
  const mainText1 = '24/7 asistencia técnica de cerrajeros';
  const mainText2 = 'en Sants con mejor precio';
  ...
  return (
    <>
      <Head>
        <title>Cerrajeros en Sants, Barcelona, urgente barato y facil, 24 Horas 666 666 666</title>
        <meta name="description" content="Cerrajeros en Sants 24 horas ✓ Apertura de puertas, cambio de bombín y cerraduras ✓ Cerrajeros Urgentes ⛔ ECONÓMICOS☝ Llegamos en 15 min ..." />
      </Head>
