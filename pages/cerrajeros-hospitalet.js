...
export default function Home() {
  const mainHeadText = 'Cerrajeros en Hospitalet';
  const mainText1 = '24/7 asistencia técnica de cerrajeros';
  const mainText2 = 'en Hospitalet con mejor precio';
  ...
  return (
    <>
      <Head>
        <title>Cerrajeros en Hospitalet, Barcelona, urgente barato y facil, 24 Horas 666 666 666</title>
        <meta name="description" content="Cerrajeros en Hospitalet 24 horas ✓ Apertura de puertas, cambio de bombín y cerraduras ✓ Cerrajeros Urgentes ⛔ ECONÓMICOS☝ Llegamos en 15 min ..." />
      </Head>
